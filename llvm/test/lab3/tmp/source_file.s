--- |
  ; ModuleID = '/home/sturmannn/llvm-nnsu-2024/llvm/test/lab3/durandin_vladimir/source_file.mir'
...
body:             |
  bb.0.entry:
    ...
    %0:gr64 = ADD64ri8 %0, 11, implicit-def $eflags
  ...
  bb.1.for.cond:
    ...
    %0:gr64 = ADD64ri8 %0, 3, implicit-def $eflags
  ...
  bb.4.if.end:
    %0:gr64 = ADD64ri8 %0, 1, implicit-def $eflags
    JMP_1 %bb.5
  ...
  bb.5.for.inc:
    ...
    %0:gr64 = ADD64ri8 %0, 4, implicit-def $eflags
    JMP_1 %bb.1
...
fixedStack:
  - { id: 0, type: spill-slot, offset: -16, size: 8, alignment: 16 }
stack:
  - { id: 0, name: n.addr, offset: -32, size: 4, alignment: 4 }
  - { id: 1, name: res, offset: -20, size: 4, alignment: 4 }
  - { id: 2, name: i, offset: -28, size: 4, alignment: 4 }
  - { id: 3, name: j, offset: -24, size: 4, alignment: 4 }
machineFunctionInfo: {}
body:             |
  bb.0.entry:
    liveins: $edi
    ...
    $rbp = frame-setup MOV64rr $rsp
    frame-setup CFI_INSTRUCTION def_cfa_register $rbp
    MOV32mr $rbp, 1, $noreg, -16, $noreg, killed renamable $edi :: (store (s32) into %ir.n.addr)
    MOV32mi $rbp, 1, $noreg, -4, $noreg, 0 :: (store (s32) into %ir.res)
    MOV32mi $rbp, 1, $noreg, -12, $noreg, 0 :: (store (s32) into %ir.i)
    %0:gr64 = ADD64ri8 %0, 8, implicit-def $eflags
  
  bb.1.for.cond:
    renamable $eax = MOV32rm $rbp, 1, $noreg, -12, $noreg :: (load (s32) from %ir.i)
    CMP32rm killed renamable $eax, $rbp, 1, $noreg, -16, $noreg, implicit-def $eflags :: (load (s32) from %ir.n.addr)
    %0:gr64 = ADD64ri8 %0, 3, implicit-def $eflags
    JCC_1 %bb.8, 13, implicit killed $eflags
  
  bb.2.for.body:
    MOV32mi $rbp, 1, $noreg, -8, $noreg, 0 :: (store (s32) into %ir.j)
    %0:gr64 = ADD64ri8 %0, 1, implicit-def $eflags
  
  bb.3.for.cond1:
    renamable $eax = MOV32rm $rbp, 1, $noreg, -8, $noreg :: (load (s32) from %ir.j)
    CMP32rm killed renamable $eax, $rbp, 1, $noreg, -16, $noreg, implicit-def $eflags :: (load (s32) from %ir.n.addr)
    %0:gr64 = ADD64ri8 %0, 3, implicit-def $eflags
    JCC_1 %bb.6, 13, implicit killed $eflags
  ...
  bb.4.for.body3:
    renamable $eax = MOV32rm $rbp, 1, $noreg, -12, $noreg :: (load (s32) from %ir.i)
    renamable $eax = ADD32rm killed renamable $eax, $rbp, 1, $noreg, -4, $noreg, implicit-def dead $eflags :: (load (s32) from %ir.res)
    MOV32mr $rbp, 1, $noreg, -4, $noreg, killed renamable $eax :: (store (s32) into %ir.res)
    renamable $eax = MOV32rm $rbp, 1, $noreg, -8, $noreg :: (load (s32) from %ir.j)
    renamable $eax = ADD32rm killed renamable $eax, $rbp, 1, $noreg, -4, $noreg, implicit-def dead $eflags :: (load (s32) from %ir.res)
    MOV32mr $rbp, 1, $noreg, -4, $noreg, killed renamable $eax :: (store (s32) into %ir.res)
    %0:gr64 = ADD64ri8 %0, 6, implicit-def $eflags
  
  bb.5.for.inc:
    renamable $eax = MOV32rm $rbp, 1, $noreg, -8, $noreg :: (load (s32) from %ir.j)
    renamable $eax = ADD32ri killed renamable $eax, 1, implicit-def dead $eflags
    MOV32mr $rbp, 1, $noreg, -8, $noreg, killed renamable $eax :: (store (s32) into %ir.j)
    %0:gr64 = ADD64ri8 %0, 4, implicit-def $eflags
    JMP_1 %bb.3
  ...
  bb.7.for.inc5:
    renamable $eax = MOV32rm $rbp, 1, $noreg, -12, $noreg :: (load (s32) from %ir.i)
    renamable $eax = ADD32ri killed renamable $eax, 1, implicit-def dead $eflags
    MOV32mr $rbp, 1, $noreg, -12, $noreg, killed renamable $eax :: (store (s32) into %ir.i)
    %0:gr64 = ADD64ri8 %0, 4, implicit-def $eflags
    JMP_1 %bb.1
